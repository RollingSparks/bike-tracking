...
void configureUblox(byte *settingsArrayPointer) {
  ...
  byte setWARM[] = {0xB5, 0x62, 0x06, 0x04, 0x04, 0x00, 0x01, 0x00, 0x02, 0x00, 0x11, 0x6C};
  delay(2500);
...
//  Serial.print(F("Set to warm start"));
//  sendUBX(setWARM, sizeof(setWARM));
//  gpsSetSuccess += getUBX_ACK(&setWARM[2]);
//  Serial.print("returns "); Serial.print(gpsSetSuccess);
