...
void loop() {
  ...
  while (gpsSerial.available()) {
    ...
    if (strbuf[stridx] == '\n') {      
      ...
      //strcpy(strbuf, "$GPGGA,170844.50,4723.10006,N,00831.23481,E,1,03,3.46,421.8,M,47.3,M,,*59");
...
//  
//  if (hasGpsUpdate && (millis() - timeLoraSent > LORA_SEND_PERIOD)) {
